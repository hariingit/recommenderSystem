...
user = pd.read_csv('userlist.txt',sep='\t')

wslist = pd.read_csv('wslist.txt',sep='\t',encoding='latin-1')
...
trdset = pd.read_csv('tpMatrix.txt',sep='\t',header=None)
...
trdset = pd.read_csv('rtMatrix.txt',sep='\t',header=None)
...
user_dataset = pd.read_csv('userlist.txt',sep='\t')

ws_list = pd.read_csv('wslist.txt',sep='\t',encoding='latin')
